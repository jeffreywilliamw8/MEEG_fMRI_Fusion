...
#=========================================================================
# Saving the correlation coefficients and regression weights
# The weights will be used for variance partitioning
#=========================================================================  
corrs_save_dir = f'/home/jeffreykatab/Projects/fusion/BOLD_EEG_Moments/Encoding_Models/results/correlations/jefe_roi/vision_language_models/dnn_type-{args.dnn_type}/{args.eeg_frequency}_Hz/fmri_sub-{args.fmri_subject}'
...
weights_save_dir = f'/scratch/jeffreykatab/Code/Encoding_Models/weights/jefe_roi/{args.dnn_type}/fmri_sub-{args.fmri_subject}/{args.hemisphere}_hemisphere'
