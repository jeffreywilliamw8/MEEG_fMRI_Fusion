...
#SBATCH --job-name=jefe_phase_2_wb
...
cd /home/jeffreykatab/Projects/fusion/BOLD_EEG_Moments/Encoding_Models/code/04_Joint_EEG_Feature_Encoding/04.1_vision_language_models
...
# Run the job
python 04c_JEFE_Phase_2_Whole_Brain.py --fmri_subject $fmri_subject --hemisphere $fmri_hemi --fmri_split $fmri_split --dnn_type $dnn_type