...
#SBATCH --job-name=decoding_encoding_wb
...
# Run the job
python 05a_Decoding_Encoding_Whole_Brain.py --fmri_subject $fmri_subject --hemisphere $fmri_hemi --fmri_split $fmri_split --dnn_type $dnn_type