...
#SBATCH --job-name=s3d_layerwise_de_phase_2_roi
...
cd /home/jeffreykatab/Projects/fusion/BOLD_EEG_Moments/Encoding_Models/code/05_Decoding_Encoding/05.2_layerwise_s3d
...
# Run the job
python 05f_S3D_Layerwise_DE_ROI.py --fmri_subject $fmri_subject --hemisphere $fmri_hemi --roi $roi --layer $layer