...
#SBATCH --job-name=encoding_fusion_whole_brain
...
# Run the job
python 02a_Encoding_Fusion_Whole_Brain.py --fmri_subject $fmri_subject --hemisphere $fmri_hemi --fmri_split $fmri_split