...
#SBATCH --job-name=compute_fmri_vertexwise_searchight_rdms
...
# Run the job
python 01a_Compute_fMRI_Vertexwise_Searchlight_RDMs.py --fmri_subject $fmri_subject --hemisphere $fmri_hemi