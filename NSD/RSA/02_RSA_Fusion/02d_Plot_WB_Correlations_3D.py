"""
This script plots the EEG-fMRI encoding fusion and RSA correlation results on inflated brain surface flatmaps for selected time points.
...
for subject in subject_list:
    corrs_dir = f'/scratch/jeffreykatab/Projects/fusion/NSD/RSA/results/correlations/searchlight_fusion/n_neighbours-100/aggregated_results/subject-{subject}'
...
plots_dir = '/scratch/jeffreykatab/Projects/fusion/NSD/RSA/plots/3D_brain_plots/subject_averaged'
