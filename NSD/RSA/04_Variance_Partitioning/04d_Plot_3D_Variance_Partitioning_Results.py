...
variance_types = ["unique_language", "unique_vision"]
...
for variance_type in variance_types:
    ...
    plots_dir = f'/scratch/jeffreykatab/Projects/fusion/NSD/RSA/plots/variance_partitioning/3D_brain_plots/subject_averaged/variance_type-{variance_type}'
    if not os.path.exists(plots_dir):
        os.makedirs(plots_dir)  # Create the directory if it does not exist

    for t in tqdm([51, 102, 128, 179, 256, 307, 358]):
        for cmap in cmaps:
            for view in views:
