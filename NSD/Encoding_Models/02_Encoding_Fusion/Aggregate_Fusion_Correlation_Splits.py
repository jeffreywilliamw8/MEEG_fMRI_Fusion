...
for subject in tqdm(subject_list):
    ...
    path_l = f'/scratch/jeffreykatab/Projects/fusion/NSD/Encoding_Models/results/correlations/encoding_fusion/whole_brain/subject-{subject}/hemisphere-lh'
    path_r = f'/scratch/jeffreykatab/Projects/fusion/NSD/Encoding_Models/results/correlations/encoding_fusion/whole_brain/subject-{subject}/hemisphere-rh'


    data_l = [[] for _ in range(359)] # This list will contain 359 lists of 163,842 correlations each
    for i in range(1,22):
        splits_path = path_l+f'/fmri_split-{i:02d}' #iterating over the split folders
    ...
    save_dir = f'/scratch/jeffreykatab/Projects/fusion/NSD/Encoding_Models/results/correlations/encoding_fusion/whole_brain/subject-{subject}'
