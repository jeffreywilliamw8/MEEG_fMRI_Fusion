...
print(f'>>> Joint EEG-Feature Encoding Fusion Phase 1 (ROI) <<<')
print('\nInput arguments:')
...
# =============================================================================
fmri_train, _ = load_fmri_roi_data(args.subject, args.hemisphere, args.roi, nc_threshold=0.20) # Shape: (9000, n_vertices), (515, n_vertices)
...
if fmri_train.shape[1]>0:
    ...
    weights_save_dir = f'/scratch/jeffreykatab/Projects/fusion/NSD/Encoding_Models/results/regression_weights/joint_eeg_feature_encoding/roi/phase_1/subject-{args.subject}'
