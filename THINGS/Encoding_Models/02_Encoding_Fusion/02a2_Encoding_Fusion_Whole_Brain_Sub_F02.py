...
# This script is for fMRI Subject 02.
#=============================================================================
...
# Subject 02 has 226,950 voxels. We split them into 534 splits of 425 voxels each.
fmri_train = fmri_train[:, 425*(args.fmri_split - 1):425*args.fmri_split] # Each split has 425 voxels
fmri_test = fmri_test[:, 425*(args.fmri_split - 1):425*args.fmri_split] # Each split has 425 voxels
...
# =============================================================================
save_dir = '/home/jeffreykatabo/Projects/fusion/THINGS/Encoding_Models/results/correlations/encoding_fusion_wb/fmri_sub-02'
